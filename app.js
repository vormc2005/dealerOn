...
const renderTotal =()=>{
    ...
    newTotals = totals.replace('%Total Sales Tax: $%', "Total Sales Tax: $" + totalOfSalesTax());
    newTotals = newTotals.replace('%Total Sale: $%', "Total Sale: $" + (totalPriceintheArray() + totalOfSalesTax()));
